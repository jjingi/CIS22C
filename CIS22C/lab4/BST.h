...
public:
  ...
  */
  BSTNode *search(Currency *key) {return searchRecur(root, key);}
  ...
  bool isEmpty(BSTNode *node) { return node == nullptr; }
};
...
/*
new question
can I modify Queue since isEmpty() is not accessible because I don't have
isEmpty in Queue() and SinglyLinkedList is protected
  */
//junk code
